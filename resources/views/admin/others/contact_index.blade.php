...
<div class="page-content">
    ...
    <h1 class="mb-5 display-5 text-center">CONTACT_TABLE</h1>
    <div class="col-sm-12 col-md-6 mb-2"><div class="dt-buttons btn-group flex-wrap">    
      <button class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatable-buttons" type="button"><span><a class="text-white" href="{{url('/contact')}}">Contact Page</a></span></button>
       ...
       <button class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0" aria-controls="datatable-buttons" type="button"><span> 
        <a class="text-white" href="{{route('contact.pdf')}}">PDF</a></button></span> <div class="btn-group">
