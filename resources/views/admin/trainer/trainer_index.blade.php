...
<div class="page-content">
    ...
    <h1 class="mb-5 display-3 text-center">TRAINER_TABLE</h1>
    ...
    <div class="table-responsive">
      <div class="col-sm-12 col-md-6 mb-2"><div class="dt-buttons btn-group flex-wrap">    
        <button class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatable-buttons" type="button"><span><a class="text-white" href="{{route('trainer.edit')}}">Create Trainer</a></span></button>
         ...
         <button class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0" aria-controls="datatable-buttons" type="button"><span> 
          <a class="text-white" href="{{route('trainer.pdf')}}">PDF</a></button></span> <div class="btn-group">
        ...
        <table class="table table-striped custom-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $trainer->id }}</td>
                    <td><a>{{ $trainer->trainer_name }}</a></td>
                    <td>
...
<button class="twtbutton">
  <a href="{{ $trainer->trainer_twitter }}" class="no-link-style">
