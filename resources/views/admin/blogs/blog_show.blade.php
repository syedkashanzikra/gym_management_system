...
<div class="page-content">
    ...
    <h1 class="mb-5 display-3 text-center">BLOGS_TABLE</h1>
    <div class="table-responsive">
      <div class="col-sm-12 col-md-6 mb-2"><div class="dt-buttons btn-group flex-wrap">    
        <button class="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatable-buttons" type="button"><span><a class="text-white" href="{{route('blog.form')}}">Create Blog</a></span></button>
         ...
         <button class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0" aria-controls="datatable-buttons" type="button"><span> 
          <a class="text-white" href="{{route('blog.pdf')}}">PDF</a></button></span> <div class="btn-group">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <td>
                            <img class="rounded avatar-lg" src="{{ (!empty($blog->Blog_headline_picture)) ? asset('upload/blogs_images/' . $blog->Blog_headline_picture) : asset('upload/images/no_image.jpg') }}" alt="Blogs Image">
                        </td>
